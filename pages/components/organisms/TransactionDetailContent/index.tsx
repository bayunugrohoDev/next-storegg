          ...
          <div className="main-content main-content-card overflow-auto">
            <section className="checkout mx-auto">
              ...
              <div className="purchase pt-30">
                ...
                <Row label="Item" value={data?._id} />
                <Row label="Price" value={`${data?.historyVoucherTopup.coinQuantity} ${data?.historyVoucherTopup.coinName}`} />
                <Row label=" Tax (10%)" value={data?.historyVoucherTopup.price} />
                <Row label="Price" value={data?.tax} />
